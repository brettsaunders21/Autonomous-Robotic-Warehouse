...
public class AStarTest {
	...
	public void test1() {
		...
		Route r3 = aStar.generateRoute(new Point(5, 1), new Point(5, 5), r1.getFinalPose(), new Route[] {},
				r1.getLength() + 1);
		r1 = new Route(r1, r3);
		r1 = new Route(r1, Action.PICKUP);

		r3 = aStar.generateRoute(new Point(5, 5), new Point(4, 7), r1.getFinalPose(), new Route[] {},
				r1.getLength() + 1);
		r1 = new Route(r1, r3);
		...
		r3 = aStar.generateRoute(new Point(5, 5), new Point(6, 5), r2.getFinalPose(), new Route[] {},
				r2.getLength() + 1);
		r2 = new Route(r2, r3);
		r2 = new Route(r2, Action.PICKUP);

		r3 = aStar.generateRoute(new Point(6, 5), new Point(5, 1), r2.getFinalPose(), new Route[] {},
				r2.getLength() + 1);
		r2 = new Route(r2, r3);
		r2 = new Route(r2, Action.PICKUP);

		r3 = aStar.generateRoute(new Point(5, 1), new Point(4, 7), r2.getFinalPose(), new Route[] {},
				r2.getLength() + 1);
		r2 = new Route(r2, r3);
		r2 = new Route(r2, Action.DROPOFF);

		Point[] ps1 = new Point[] { new Point(1, 0), new Point(2, 0), new Point(3, 0), new Point(4, 0), new Point(5, 0),
				new Point(5, 1), new Point(5, 1), new Point(5, 2), new Point(5, 3), new Point(5, 4), new Point(5, 5),
				new Point(5, 5), new Point(5, 6), new Point(4, 6), new Point(4, 7), new Point(4, 7) };
		assertArrayEquals(ps1, r1.getCoordinatesArray());
		Point[] ps2 = new Point[] { new Point(5, 5), new Point(5, 5), new Point(6, 5), new Point(6, 5), new Point(6, 4),
				new Point(6, 3), new Point(6, 2), new Point(5, 2), new Point(5, 1), new Point(5, 1), new Point(5, 2),
				new Point(5, 3), new Point(5, 4), new Point(5, 5), new Point(5, 6), new Point(4, 6), new Point(4, 7),
				new Point(4, 7) };

		assertArrayEquals(ps2, r2.getCoordinatesArray());

		Action[] as1 = new Action[] { Action.FORWARD, Action.FORWARD, Action.FORWARD, Action.FORWARD, Action.FORWARD,
				Action.LEFT, Action.PICKUP, Action.FORWARD, Action.FORWARD, Action.FORWARD, Action.FORWARD,
				Action.PICKUP, Action.FORWARD, Action.LEFT, Action.RIGHT, Action.DROPOFF };
		assertArrayEquals(as1, r1.getDirectionArray());

		// Point[] as2 = new Action[] {new Point(5,5), new Point(5,5), new Point(6,5),
		// new Point(6,5), new Point(6,4), new Point(6,3), new Point(6,2), new
		// Point(5,2), new Point(5,1), new Point(5,1), new Point(5,2), new Point(5,3),
		// new Point(5,4), new Point(5,5), new Point(5,6), new Point(4,6), new
		// Point(4,7), new Point(4,7)};
