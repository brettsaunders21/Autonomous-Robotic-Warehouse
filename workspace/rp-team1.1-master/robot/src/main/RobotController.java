...
/**
 * RobotController class Main class responsible for receiving commands from the
 * network handler and sending it to the robot for execution
 * 
 * @author oia799
 *
 */
public class RobotController implements StoppableRunnable {
	...
	/**
	 * Gets the average of the light value readings from the sensors
	 * 
	 * @return value: the average light value
	 */
	...
	/**
	 * Used for calibration of light sensors
	 */
